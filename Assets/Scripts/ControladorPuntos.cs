...
public class ControladorPuntos : MonoBehaviourPunCallbacks
{
    ...
    //public TMP_Text InfoPartida; // agregado bus no funciona
    public string tomarDatosRival = "0";
    //public string hiddenVariable = "0"; /// agregado bus no funciona
    ...
    //[PunRPC]                                             //// Agregado Bus no funciona el comparar valores
    //public void CompararValores()
    //{
    //    hiddenVariable = int.TryParse(VariableRedText.text);
